...
python3 examples/jarvis/scripts/build_ndjson_golden.py

# Write to a specific directory (for diff testing)
python3 examples/jarvis/scripts/build_ndjson_golden.py --output /tmp/golden-check

# Check for drift against committed golden (exit 1 if any file differs)
python3 examples/jarvis/scripts/build_ndjson_golden.py --check
```
...
cargo run --bin jarvis-cal -- emit-fixtures-for-parity --input examples/jarvis/tests/fixtures/ndjson-parity/inputs --output /tmp/rust-golden
diff -r examples/jarvis/tests/fixtures/ndjson-parity/golden /tmp/rust-golden
```
...
go run ./cmd/jarvis-state emit-fixtures-for-parity --input examples/jarvis/tests/fixtures/ndjson-parity/inputs --output /tmp/go-golden
diff -r examples/jarvis/tests/fixtures/ndjson-parity/golden /tmp/go-golden
```
