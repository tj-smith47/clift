...
# jarvis_native_clock.bats — coverage for lib/native/clock.sh, the wrapper
...
setup() {
  CLI_DIR_REAL="$(cd "${BATS_TEST_DIRNAME}/../examples/jarvis" && pwd)"
  FRAMEWORK_DIR_REAL="$(cd "${BATS_TEST_DIRNAME}/.." && pwd)"
