#!/usr/bin/env bats
# Tests for examples/jarvis/lib/notify/dispatch.sh — multi-channel fan-out,
...
setup() {
  ...
  # shellcheck source=/dev/null
  source "${CLIFT_JARVIS_DIR}/lib/notify/registry.sh"
  # shellcheck source=/dev/null
  source "${CLIFT_JARVIS_DIR}/lib/notify/local.sh"
  # shellcheck source=/dev/null
  source "${CLIFT_JARVIS_DIR}/lib/notify/gotify.sh"
  # shellcheck source=/dev/null
  source "${CLIFT_JARVIS_DIR}/lib/notify/slack.sh"
  # shellcheck source=/dev/null
  source "${CLIFT_JARVIS_DIR}/lib/notify/dispatch.sh"
  state_ensure_tree
