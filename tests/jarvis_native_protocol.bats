...
FRAMEWORK_DIR_REAL="$(cd "$(dirname "$BATS_TEST_FILENAME")/.." && pwd)"
JARVIS_DIR_REAL="${FRAMEWORK_DIR_REAL}/examples/jarvis"
PROTOCOL_LIB="${JARVIS_DIR_REAL}/lib/native/protocol.sh"
LOG_LIB="${FRAMEWORK_DIR_REAL}/lib/log/log.sh"

setup() {
  jarvis_common_setup
  export FRAMEWORK_DIR="$FRAMEWORK_DIR_REAL"
  export CLIFT_JARVIS_DIR="$JARVIS_DIR_REAL"
